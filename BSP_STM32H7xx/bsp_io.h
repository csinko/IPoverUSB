/**
  ******************************************************************************
  * @file    bsp_io.h
  * @author  Cameron Sinko (Adapted From Benedek Kupper)
  * @version 0.1
  * @date    2020-01-23
  * @brief   IPoverUSB BSP for I/O pins for STM32H7
  *
...
#define LED6_BLUE_PIN       PB7
#define LED5_RED_PIN        PB14
#define LED4_GREEN_PIN      PB0
